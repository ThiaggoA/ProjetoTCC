<?php
/* Smarty version 3.1.39, created on 2021-10-10 05:16:23
  from 'C:\xampp\htdocs\Quitanda\view\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61625b070da4e1_41519313',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '43aa2bb9d00cae22a2e4dd462b70efaf6ce46a5a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Quitanda\\view\\index.tpl',
      1 => 1633835777,
      2 => 'file',
    ),
  ),
...
function content_61625b070da4e1_41519313 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="pt-br">
...
/index.php"><strong>Quitanda Comunitária</strong></a>
...
/index.php" class="nav-link text-white">Home</a>
                    </li>
                    <li class="nav-item">
...
/icons/cart3.svg" alt="Bootstrap" width="24" height="24" fill="currentColor">
                            </a>
                        </li>
                    </ul>
        ...
        <div id="carouselMain" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active text-center" data-interval="3000">
                    <!-- <img src="<?php echo $_smarty_tpl->tpl_vars['GET_MEDIA']->value;?>
/slides/slide01.jpg" alt="" class="img-fluid d-block d-md-block"> 20.09.2021 -->
                    <img src="<?php echo $_smarty_tpl->tpl_vars['GET_MEDIA']->value;?>
/slides/slide01.jpg" alt="" class="img-fluid d-none d-md-block">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['GET_MEDIA']->value;?>
/slides/slide01small.jpg" alt="" class="img-fluid d-block d-md-none">
                </div>
            ...
            <div class="row g-3">
                ...
                <div class=" col-xl-2 col-lg-3 col-md-4 col-sm-6 d-flex align-items-stretch">
                    <div class="card text-center bg-light">
                        <a href="#" class="position-absolute right-0 p-2 text-danger">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['GET_MEDIA']->value;?>
/icons/suit-heart.svg" alt="Bootstrap" width="24" height="24" fill="currentColor">
                        </a>
                        <img src="<?php echo $_smarty_tpl->tpl_vars['GET_MEDIA']->value;?>
/Produtos/0001.webp" class="card-img-top">
...
/bootstrap/dist/js/bootstrap.bundle.js"><?php echo '</script'; ?>
>
  </body>
</html><?php }
}
